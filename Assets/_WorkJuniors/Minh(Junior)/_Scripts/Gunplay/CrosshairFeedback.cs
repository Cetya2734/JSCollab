...
//         if (isZooming)
//         {
//             // If zooming, reset to the center
//             top.DOLocalMoveY(0, animationDuration).SetEase(Ease.OutQuad);
//             bottom.DOLocalMoveY(0, animationDuration).SetEase(Ease.OutQuad);
//             left.DOLocalMoveX(0, animationDuration).SetEase(Ease.OutQuad);
//             right.DOLocalMoveX(0, animationDuration).SetEase(Ease.OutQuad);
//         }
//         else
//         {
//             // If not zooming, reset to original positions
//             top.DOLocalMoveY(topStart.y, animationDuration).SetEase(Ease.OutQuad);
//             bottom.DOLocalMoveY(bottomStart.y, animationDuration).SetEase(Ease.OutQuad);
//             left.DOLocalMoveX(leftStart.x, animationDuration).SetEase(Ease.OutQuad);
//             right.DOLocalMoveX(rightStart.x, animationDuration).SetEase(Ease.OutQuad);
...
//     public void AnimateCrosshair()
//     {
//         // Ensure crosshair squares are visible during animation
//         top.gameObject.SetActive(true);
//         bottom.gameObject.SetActive(true);
//         left.gameObject.SetActive(true);
//         right.gameObject.SetActive(true);
//
//         // Reset opacity
//         top.GetComponent<Image>().DOFade(1, 0);
//         bottom.GetComponent<Image>().DOFade(1, 0);
//         left.GetComponent<Image>().DOFade(1, 0);
//         right.GetComponent<Image>().DOFade(1, 0);
//
//         // Move outward
//         top.DOLocalMoveY(topStart.y + moveDistance, animationDuration).SetEase(Ease.OutQuad);
//         bottom.DOLocalMoveY(bottomStart.y - moveDistance, animationDuration).SetEase(Ease.OutQuad);
...
//             right.DOLocalMoveX(0, animationDuration).SetEase(Ease.OutQuad);
//
//             // Fade out squares after resetting to center
//             top.GetComponent<Image>().DOFade(0, animationDuration);
//             bottom.GetComponent<Image>().DOFade(0, animationDuration);
//             left.GetComponent<Image>().DOFade(0, animationDuration);
//             right.GetComponent<Image>().DOFade(0, animationDuration).OnComplete(() =>
//             {
//                 // Hide crosshair squares completely after animation
//                 top.gameObject.SetActive(false);
//                 bottom.gameObject.SetActive(false);
...
public class CrosshairFeedback : MonoBehaviour
{
    ...
    public void AnimateCrosshair()
    {
        // Hide the zoom circle (dot) when the animation starts
        if (isZooming)
        {
            zoomCircle.gameObject.SetActive(false);
        }
    ...
    void ResetCrosshair()
    {
        if (isZooming)
        {
            ...
            right.GetComponent<Image>().DOFade(0, animationDuration).OnComplete(() =>
            {
                ...
                // Show the zoom circle (dot) again after the animation ends
                zoomCircle.gameObject.SetActive(true);
            });
        }
        else
